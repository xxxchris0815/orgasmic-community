...
| `orgasmic-fc-app/` | **1.1.30** | PWA, Web Push, Kommentar-/RSVP-Stack, navy StatusBar, FCM-Kanal |
...
ZIP: [`orgasmic-fc-app-1.1.30.zip`](https://github.com/xxxchris0815/orgasmic-community/raw/cursor/migrate-community-plugins-d4ba/orgasmic-fc-app-1.1.30.zip)
