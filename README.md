...
| `orgasmic-fc-embeds/` | **1.2.1** | Bunny-Player, nativer Composer-Upload, Autoplay, Wiedergabe-Tracking + Webhook |
...
ZIP: [`orgasmic-fc-embeds-1.2.1.zip`](https://github.com/xxxchris0815/orgasmic-community/raw/cursor/migrate-community-plugins-d4ba/orgasmic-fc-embeds-1.2.1.zip)
