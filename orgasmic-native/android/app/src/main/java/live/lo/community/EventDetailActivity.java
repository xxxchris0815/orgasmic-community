...
public class EventDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        join = findViewById(R.id.event_join);
    ...
    private void load() {
        HybridRuntime.API.get("orgasmic-events/v1/events/" + eventId, new ApiClient.JsonCallback() {
            ...
            public void onOk(JSONObject json) {
                ...
                String mine = rsvpLabel(rsvp != null ? rsvp.opt("mine") : null);
                ...
                if (joinUrl == null || joinUrl.isEmpty() || "null".equals(joinUrl)) {
                    join.setVisibility(View.GONE);
                } else {
                    join.setVisibility(View.VISIBLE);
                    join.setOnClickListener(v -> startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(joinUrl))));
                }
            }
    ...
    private static String rsvpLabel(Object raw) {
        if (raw == null || raw == JSONObject.NULL) {
            return "";
        }
        String value = String.valueOf(raw);
        if ("going".equals(value)) {
            return "Dabei";
        }
