...
6. Weiter runter zu **Grafiken** / **Graphics**. Dateien vom Rechner, Drag-and-drop oder **Hochladen**:
   ...
   | Feld | Pflicht | Format |
   | --- | --- | --- |
   | **App-Symbol** / App icon | ja | [`orgasmic-native/store/play-icon-512.png`](../store/play-icon-512.png) — **genau 512×512**, Gold auf Weiß, ohne Schrift |
   | **Feature-Grafik** / Feature graphic | ja | [`orgasmic-native/store/play-feature-1024x500.png`](../store/play-feature-1024x500.png) — **genau 1024×500**, Banner oben im Store (Logo + **LO Community** + Weiblichkeit. Verbindung. Schwesternschaft.) |
